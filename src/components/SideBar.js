...
import { NavItem, Nav, Collapse, Card, CardBody } from "reactstrap";
...
const SideBar = () => {
  ...
  const btnClass = `btn shadow-none ${classes["button-prop-active"]}`;
  const btnClassInactive = `btn shadow-none ${classes["button-prop"]}`;
    ...
    <NavbarLayout>
      <Nav vertical>
        ...
        <div className={classes.blocks}>
          <NavItem>
            <div className={classes.userdiv}>User panel</div>
          </NavItem>
          <div className={classes.userview}>
            <NavItem>
              <NavLink
                className={({ isActive }) =>
                  isActive ? btnClass : btnClassInactive
                }
                to="/articles"
              >
                <svg
          ...
          {user.superuser && (
            <>
              <div className={classes.userdiv}>Admin panel</div>
          ...
          <NavItem>
            <div className={classes.userdiv}>Preferences</div>
          </NavItem>
          <div className={classes.preferences}>
            <NavItem>
              <NavLink className={btnClassInactive}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
